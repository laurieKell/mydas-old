...
The fishery was aassumed to only catch mature fish and so selection pattern is modelled by a double normal equivalent to the maturity ogive,  parameters were $a_1$, $s_l$ and $s_r$ were (`r signif(mean(lh["a1"],na.rm=TRUE),3)`, `r signif(mean(lh["sl"],na.rm=TRUE),3)`, `r signif(mean(lh["sr"],na.rm=TRUE),3)`) respectively.
