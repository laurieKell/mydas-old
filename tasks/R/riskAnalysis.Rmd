...
```{r lhpar-save}
save(lhpcns,  file=file.path(dirDat,"lhpcns.RData"))
save(lhpmydas,file=file.path(dirDat,"lhpmydas.RData"))
save(gurnards,file=file.path(dirDat,"gurnards.RData"))
save(skates,  file=file.path(dirDat,"skates.RData"))
```
