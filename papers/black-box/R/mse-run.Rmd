...
dirMy="/home/laurence/Desktop/sea++/MyDas/papers/bwg-box"
...
save(eql,  file=file.path(dirDat,"eql.RData"),  compress="xz")
save(srDev,file=file.path(dirDat,"srDev.RData"),compress="xz")
save(uDev, file=file.path(dirDat,"uDev.RData"), compress="xz")
