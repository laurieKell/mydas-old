...
maxf =mean(refpts(eqRay)["crash","harvest"]/refpts(eqRay)["msy","harvest"]*0.75)
...
maxf =mean(refpts(eqSprat)["crash","harvest"]/refpts(eqSprat)["msy","harvest"]*0.75)
...
maxf =mean(refpts(eqBigeye)["crash","harvest"]/refpts(eqBigeye)["msy","harvest"]*0.75)
...
maxf =mean(refpts(eqPlaice)["crash","harvest"]/refpts(eqPlaice)["msy","harvest"]*0.75)
