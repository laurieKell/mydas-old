...
```{r refBmsy,fig.margin=TRUE, fig.width=4, fig.height=3,fig.cap="Densities of Stock from different methods for estimating uncertainty."}
...
```{r MCkobe,fig.margin=TRUE,fig.width=6,fig.height=6}
library(plyr)
library(mpb)
library(reshape)
library(kobe)
