...
tblrnk10       = transform(tblrnk10, fill=cut(value, c(1000000,2000000, 3000000, 4000000, 5000000,10000000,20000000)))
...
tblval10       = transform(tblval10, fill=cut(rank, c(8,12,14,18,20,22,24)))
...
```
>>>>>>> 0eacaeaf747b5ffd8e89fe71d49f784c8f6398db
